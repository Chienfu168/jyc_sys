...
<form class="form" method="post" action="<?= e($action) ?>">
    ...
    <div class="grid-form">
        ...
        <label>
            <span>是否檢附報價單</span>
            <?php $quotationAttached = (string) old('quotation_attached', (string) ($request['quotation_attached'] ?? '1')); ?>
        ...
        <label>
            <span>未附報價單原因</span>
            <input type="text" name="quotation_missing_reason" value="<?= e((string) old('quotation_missing_reason', $request['quotation_missing_reason'] ?? '')) ?>">
        </label>
        <label class="span-2">
            <span>請購事由</span>
