    ...
    <div class="panel-header no-print">
        ...
        <div class="actions">
            ...
            <?php if ($canManage): ?>
                ...
                <?php endif; ?>
            <?php endif; ?>
            <?php if (\App\Core\Permission::can('income_expenses.delete') || owns_record($record['created_by'] ?? null)): ?>
                <form method="post" action="/income-expenses/<?= e((string) $record['id']) ?>/delete" onsubmit="return confirm('確定要刪除此收支紀錄？此操作無法復原（已建立會計傳票者無法刪除）。');">
                    <?= csrf_field() ?>
