    ...
    public static function sources(): array
    {
        return [
            ...
            [
                ...
                'target_type' => 'purchase_requests',
                'label' => '採購申請',
                'permission' => 'purchase_requests.approve',
                'table' => 'purchase_requests',
                'subject_column' => 'subject',
                'category_column' => 'purchase_category',
                'date_column' => 'requested_on',
                'amount_column' => 'total_amount',
                'type_column' => 'status',
                'show_path' => '/purchase-requests/',
                'approve_path' => '/purchase-requests/%d/approve',
                'reject_path' => '/purchase-requests/%d/reject',
            ],
            [
